...
struct global_data_all_processes : public parameters
{
  ...
  int PotTracerType;          // TEST: add a runtime parameter for potential tracer test particles
  int RecenterPartType;          // particle type to recenter particles
  int PotOutStep;                // step to output potential of the potential tracer  particles
  char PotOutFile[MAXLEN_PATH];  // file to output potential of the potential tracer  particles
